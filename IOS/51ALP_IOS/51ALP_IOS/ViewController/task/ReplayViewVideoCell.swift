//
//  ReplayViewVideoCell.swift
//  51ALP_IOS
//
//  Created by xiu on 3/19/19.
...
class ReplayViewVideoCell:UITableViewCell {
    ...
    var replay: Replay! {
        didSet {
            ...
            if replay.isVideoReplay {
                if let url: URL = URL(fileURLWithPath: ENV.BACKENDURL.rawValue + replay.videoPath) {
                    ...
                    taskName.snp.makeConstraints { (make) in
                        ...
                        make.left.equalTo(self.name.snp.left).offset(5)
                    ...
                    let asset = BMPlayerResource(name: replay.videoName,
                    ...
                    controller!.disableFullscreenButton()
                    ...
                    player!.snp.makeConstraints { (make) in
                        make.top.equalTo(self.taskName.snp.bottom).offset(5)
