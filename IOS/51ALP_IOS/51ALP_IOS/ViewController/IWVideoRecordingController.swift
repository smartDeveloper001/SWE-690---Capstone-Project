...
class IWVideoRecordingController: UIViewController {
    ...
    @objc private func onClickedStartButton(startButton: UIButton) {
        ...
        if !isRecording {
            ...
            filePath = "\(documentDirectory)/\(dateFormatter.string(from: Date())).mp4"
            
            //filePath = "\(documentDirectory)/test.mp4"
    ...
    @objc private func onClickedEndButton(endButton: UIButton) {
        ...
        self.delegate?.backValue(videoName: "", videoPath: filePath)
...
//        }
    ...
    @objc private func backAction() {
        print("IWVideoRecordingController backAction")
        self.dismiss(animated: true, completion: nil)
