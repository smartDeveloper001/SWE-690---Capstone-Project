...
//        }
        ...
        rotateButton.layer.cornerRadius = 3
        ...
        rotateButton.setTitle(" 旋转视频 ", for: .normal)
        rotateButton.addTarget(self, action: #selector(onRotateButtonPressed), for: .touchUpInside)
        rotateButton.titleLabel?.font   = UIFont.systemFont(ofSize: 10)
